...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: 'white', color: '#1d1d1f', overflowX: 'hidden', fontFamily: '-apple-system, sans-serif' }}>
      ...
      {/* SECTION 2: TESTIMONIAL SLIDER (Smaller, cleaner) */}
      ...
      {/* SECTION 3: MEET THE PARTNERS (Horizontal Lane with Top Alignment) */}
      ...
      {/* SECTION 4: OPPORTUNITIES (Detailed Snippets) */}
      <section style={{ padding: '100px 24px', backgroundColor: '#fbfbfd', borderTop: '1px solid #f2f2f2' }}>
